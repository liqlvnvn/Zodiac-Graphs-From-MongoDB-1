...
/* package Chart-1.3.3 */
#define VERSION_Chart "1.3.3"
#define MIN_VERSION_Chart(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  3 || \
  (major1) == 1 && (major2) == 3 && (minor) <= 3)

/* package Chart-cairo-1.4 */
#define VERSION_Chart_cairo "1.4"
...
/* package hs-gchart-0.4.1 */
#define VERSION_hs_gchart "0.4.1"
#define MIN_VERSION_hs_gchart(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  4 || \
  (major1) == 0 && (major2) == 4 && (minor) <= 1)

/* package mongoDB-2.0.5 */
#define VERSION_mongoDB "2.0.5"
